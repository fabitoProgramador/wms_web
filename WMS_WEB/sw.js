...
const CACHE='wms-map-shell-v116';
const CORE=[
  ...
  './js/config/almacenes.js','./js/config/identidadPlanta.js','./js/config/turnos.js','./js/config/catalogo.js','./js/config/estados.js','./js/config/mapaConfig.js','./js/config/destinosAnden.js','./js/config/navegacion.js',
