...
const CACHE='wms-map-shell-v127';
const CORE=[
  './','./index.html','./assets/logo.png','./assets/icono.ico',
  './css/main.css','./css/components.css','./css/dashboard.css','./css/gruero.css','./css/inventory-operation.css','./css/operaciones.css','./css/stock.css','./css/mapa-2d5.css','./css/labels.css','./css/responsive.css','./css/theme-system.css',
  ...
  './js/models/userModel.js','./js/models/palletModel.js','./js/models/mapaModel.js','./js/models/panelControlModel.js','./js/models/dashboardModel.js','./js/models/dashboardAnalysisModel.js','./js/models/dashboardMonitorModel.js','./js/models/operacionesModel.js','./js/models/stockModel.js','./js/models/stockPlantaModel.js','./js/models/loteDetalladoModel.js','./js/models/labelHistoryModel.js','./js/models/inventoryOperationModel.js',
