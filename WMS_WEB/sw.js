...
const CACHE='wms-map-shell-v122';
const CORE=[
  ...
  './js/models/userModel.js','./js/models/palletModel.js','./js/models/mapaModel.js','./js/models/panelControlModel.js','./js/models/dashboardModel.js','./js/models/stockModel.js','./js/models/labelHistoryModel.js','./js/models/inventoryOperationModel.js',
